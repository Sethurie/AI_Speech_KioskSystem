...
export const menuAliases = {
  101: ["모닝세트", "말말모닝세트", "베이글세트", "아메리카노세트"],
  102: ["디저트세트", "말말디저트세트", "케이크세트"],
  103: ["시그니처세트", "말말시그니처세트", "마카롱세트"],
  201: ["아인슈페너", "말말아인슈페너"],
  202: ["흑임자라떼", "흑임자", "흑임자샷라떼", "말말흑임자"],
  203: ["레드크림슨티", "레드크림슨", "크림슨티", "말말레드"],
  1: ["아메리카노", "아아", "뜨아", "아메", "카페아메리카노"],
  2: ["라떼", "카페라테", "카페라떼", "라테"],
  3: ["바닐라라떼", "바닐라", "바라", "바닐라라테"],
  4: ["카라멜마끼아또", "마끼아또", "카라멜", "마키아토", "카라멜마키아토"],
  5: ["콜드브루", "콜드블루", "콜드브르"],
  6: ["에스프레소", "에쏘"],
  7: ["카푸치노"],
  8: ["돌체라떼", "연유라떼", "돌체", "돌체라테"],
  9: ["초코", "초콜릿", "시그니처초콜릿", "아이스초코", "핫초코", "초코라떼"],
  10: ["말차라떼", "녹차라떼", "말차", "녹차", "말차라테"],
  11: ["딸기라떼", "딸기우유"],
  12: ["고구마라떼", "고구마"],
  13: ["딸기에이드", "피치딸기에이드", "딸기에이드"],
  14: ["쿨라임", "라임", "쿨라임에이드", "라임에이드"],
  15: ["청포도에이드", "청포도", "포도에이드"],
  16: ["자몽에이드", "자몽주스"],
  17: ["치즈케이크", "치즈케익", "치케", "번트치즈케이크", "치즈케잌"],
  18: ["티라미수", "티라미슈", "마스카포네티라미수"],
  19: ["스콘", "클래식스콘"],
  20: ["마카롱", "블루베리마카롱"],
  21: ["크루아상", "크로와상", "버터크루아상", "크루와상"],
  22: ["베이글", "어니언베이글", "양파베이글"],
  23: ["샌드위치", "에그샌드위치", "계란샌드위치"],
  24: ["카스테라", "생크림카스테라", "카스텔라"],
  25: ["자몽티", "자허블", "자몽허니블랙티", "자몽차", "자몽블랙티"],
  26: ["유자티", "유자", "민트티", "유자민트티", "유자차"],
  27: ["밀크티", "로얄밀크티"],
  28: ["캐모마일", "캐모마일티", "카모마일"],
  29: ["두바이초콜릿", "두바이초코", "두바이초콜렛", "두바이", "두쫀쿠"],
  30: ["민트초코라떼", "민트초코", "민초", "민초라떼"],
  31: ["토피넛라떼", "토피넛"],
  32: ["레몬에이드", "레몬주스"],
  33: ["블루레몬에이드", "블루레몬에이드", "블루에이드", "블루레몬"],
  34: ["얼그레이", "얼그레이티"],
  35: ["페퍼민트", "페퍼민트티", "민트티"]
};
